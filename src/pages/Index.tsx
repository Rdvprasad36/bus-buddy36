...
export default function Index() {
  ...
  if (showIntro) {
    return <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-blue-900 dark:to-gray-900">
  ...
  return <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white dark:from-blue-900 dark:to-gray-900">
        ...
        <div className="flex flex-col gap-6">
          ...
          <section className="mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-4 mb-6">
              ...
              <Map className="h-[400px] w-full mb-2" useGoogleMaps={true} allowEditing={false} location="visakhapatnam bus routes" showBusStopsOnly={true} showTraffic={true} />
          ...
          <section className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all hover:scale-105">
              ...
              <Button onClick={handleGetBusClick} className="w-full">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all hover:scale-105">
              ...
              <Button variant="outline" onClick={handleShareLocationClick} className="w-full">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all hover:scale-105">
              <div className="mb-4 bg-blue-100 dark:bg-blue-900 p-3 rounded-full w-fit">
                <div className="relative">
                  <img src="/lovable-uploads/c9c1e147-3efb-42c9-94c9-6b5fe15da20d.png" alt="Boochi" className="h-8 w-8" />
                </div>
              </div>
              ...
              <Button variant="default" onClick={toggleAIAgent} className="w-full bg-purple-600 hover:bg-purple-700">
          ...
          <section className="text-center mb-8">
            <div className="bg-blue-600 text-white rounded-xl p-8 shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button variant="secondary" size="lg" onClick={() => navigate("/signup")} className="text-purple-700 bg-white hover:bg-purple-50">
                  <User className="mr-2 h-4 w-4" />
                  Sign Up
                </Button>
                <Button variant="outline" size="lg" className="text-black border-white hover:bg-white/20" onClick={() => navigate("/home")}>
      ...
      <Button onClick={toggleAIAgent} className="fixed bottom-4 right-4 h-14 w-14 rounded-full shadow-lg z-50 p-0 bg-purple-600 hover:bg-purple-700">
        <img src="/lovable-uploads/c9c1e147-3efb-42c9-94c9-6b5fe15da20d.png" alt="Boochi" className="h-8 w-8" />
      </Button>
