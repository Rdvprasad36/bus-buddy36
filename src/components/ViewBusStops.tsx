...
export function ViewBusStops({ busNumber, onBack }: ViewBusStopsProps) {
  ...
  const busStops = {
    "1C": [
      ...
      { name: "NAD Junction", time: "6:35 AM", distance: "10.1 km", passed: false },
    ...
    "28C": [
      ...
      { name: "BHPV", time: "6:50 AM", distance: "5.1 km", passed: true },
      { name: "NAD Junction", time: "7:05 AM", distance: "8.7 km", passed: true },
    ...
    "999": [
      ...
      { name: "Adavivaram", time: "7:15 AM", distance: "3.5 km", passed: true },
    ...
    "400": [
      ...
      { name: "MVP Colony", time: "6:45 AM", distance: "8.9 km", passed: false },
    ...
    "37G": [
      ...
      { name: "Kancharapalem", time: "7:15 AM", distance: "7.6 km", passed: false },
  ...
  const defaultStops = [
    ...
    { name: "Stop 2", time: "~20 min", distance: "~7 km", passed: false },
          ...
          <div className="relative">
            ...
            <div className="relative z-10">
              {stops.map((stop, index) => (
                <div 
                  key={index} 
                  className={`flex items-start mb-6 ${index === currentStopIndex ? 'opacity-100' : 'opacity-70'}`}
                >
